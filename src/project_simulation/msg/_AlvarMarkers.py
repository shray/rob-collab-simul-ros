"""autogenerated by genpy from project_simulation/AlvarMarkers.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import project_simulation.msg
import geometry_msgs.msg
import std_msgs.msg

class AlvarMarkers(genpy.Message):
  _md5sum = "bf5718fe62b84cd15d9fe396f0b1de3a"
  _type = "project_simulation/AlvarMarkers"
...
"""
  ...
  _slot_types = ['std_msgs/Header','project_simulation/AlvarMarker[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = project_simulation.msg.AlvarMarker()
        _v9 = val1.header
        start = end
        end += 4
