"""autogenerated by genpy from project_simulation/AlvarMarker.msg. Do not edit."""
import sys
...
class AlvarMarker(genpy.Message):
  _md5sum = "7b611310a2363bd431e43a9c309dbb1e"
  _type = "project_simulation/AlvarMarker"
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint32','geometry_msgs/PoseStamped']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_4I.pack(_x.id, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _struct_4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
